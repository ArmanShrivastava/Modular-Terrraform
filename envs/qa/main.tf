# SMS QA Environment - Main Configuration
# Manages all SMS infrastructure components for QA environment
...
module "network" {
  ...
  subnets = {
    appgw-subnet = {
      ...
      network_security_group_id = module.network_security_groups.nsg_ids["appgw-nsg"]
    }
    jumpbox-subnet = {
      address_prefixes          = ["10.10.5.0/26"]
      network_security_group_id = module.network_security_groups.nsg_ids["jumpbox-nsg"]
    }
    aks-subnet = {
      address_prefixes          = ["10.10.2.0/23"]
      network_security_group_id = module.network_security_groups.nsg_ids["aks-nsg"]
      service_endpoints         = ["Microsoft.Sql"]
    }
    private-endpoints-subnet = {
      address_prefixes                  = ["10.10.4.0/24"]
      network_security_group_id         = module.network_security_groups.nsg_ids["private-endpoints-nsg"]
      service_endpoints                 = ["Microsoft.Sql"]
      private_endpoint_network_policies = "Disabled"
    }
    ado-agents-subnet = {
      address_prefixes                  = ["10.10.20.0/24"]
      network_security_group_id         = module.network_security_groups.nsg_ids["ado-agent-nsg"]
      private_endpoint_network_policies = "Disabled"
    }
  }
  ...
  peerings = {
    sms-dev-peering = {
      remote_virtual_network_id    = try(var.peering_remote_vnet_id, null)
